...
// --- Fix Cloudinary URL to return raw image for Godot ---
...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        // --- Upload game file to Cloudinary (raw) ---
        ...
        await set(ref(db, `games/${gameId}`), {
            ...
            name,
            description: desc,
            icon: fixCloudinaryUrl(iconJson.secure_url), // ✅ Fixed for Godot
            file: gameJson.secure_url,
            creator: username
        });
